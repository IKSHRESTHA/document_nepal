...
Context: Nepal’s total non-life premiums are small (roughly NPR 45 billion), and total market premiums (life + non-life) are in the NPR 140–150 billion range. Thus, insured losses from a single SRCC event can represents a large fraction of annual premium income and strain capital adequacy.
